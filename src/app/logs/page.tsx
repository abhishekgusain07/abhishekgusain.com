    ...
    return (
      <main className="mx-auto max-w-screen-md px-4 py-28 flex flex-col gap-8">
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-neutral-6 dark:text-neutral-dark-6">
            Loading logs...
          </div>
        </div>
      </main>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Popover>
            ...
            <PopoverContent
              className="w-auto p-0 bg-white dark:bg-neutral-dark-1 border-neutral-3 dark:border-neutral-dark-3"
              align="start"
            >
              <Calendar
                mode="single"
          ...
          <span className="text-neutral-6 dark:text-neutral-dark-6 text-sm">
            to
          </span>
